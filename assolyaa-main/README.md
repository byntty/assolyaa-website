...
containing the production Convex URL. If no Convex project is configured yet,
the site can still be built and published; authentication features will need a
Convex deployment before they can be used.
