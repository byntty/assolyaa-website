...
const education = [
  {
    year: "2019–2021",
    title: "Магистратура — «Изобразительное искусство» (научно-педагогический профиль)",
    venue:
  ...
  },
  {
    ...
    venue: "Казахский национальный университет искусств (КазНУИ), факультет живописи, Астана",
  },
  {
    year: "2009–2013",
    title: "Колледж — «Станковая живопись» (диплом с отличием)",
    venue: "Колледж при Казахском национальном университете искусств (КазНУИ), Астана",
  },
  {
    year: "2006–2009",
            ...
            <FadeIn>
              <div>
                ...
                <p className="mt-6 font-sans text-[11px] uppercase tracking-[0.2em] text-muted-foreground">
                  Assel Sabyrzhankyzy &middot; Ассоль / Assolyaa &middot; Асель Бекжан
                </p>
                <p className="mt-2 font-sans text-[11px] uppercase tracking-[0.2em] text-muted-foreground">
                  Род. 7 марта 1994, Алматы &middot; Instagram / TikTok — @assolyaa
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.15}>
              <div className="flex flex-col justify-end">
                <p className="font-sans text-sm leading-[1.9] text-muted-foreground">
                  ...
                  наук, автор креативного цифрового контента и создатель авторского
                  направления KilemArt. Работает в жанрах современной и портретной
                  живописи, гиперреализма — и в собственном направлении картин на коврах,
                  основанном на казахском и тюркском культурном коде.
                </p>
                <p className="mt-6 font-sans text-sm leading-[1.9] text-muted-foreground">
                  Творчество отмечено на государственном уровне: медалью «Ерен еңбегі
                  үшін», нагрудным знаком «Алтын Барыс» и благодарностями Президента
                  Республики Казахстан, — а также признано международными платформами:
                  в 2026 году Асель вошла в топ-50 мировых новаторов TikTok The Discover
                  List (категория Innovators) как единственная представительница
                  Казахстана.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.1} className="lg:col-span-8">
              <div className="space-y-8">
                ...
                <p className="font-sans text-sm leading-[1.9] text-muted-foreground">
                  ...
                  лидеров Алаш, Бауыржана Момышулы, Динмухамеда Кунаева, Жошы хана и Умай.
                </p>
                <p className="font-sans text-sm leading-[1.9] text-muted-foreground">
                ...
                <p className="font-sans text-sm leading-[1.9] text-muted-foreground">
                  С 2025 года Ассоль передаёт авторские ковровые портреты мировым звёздам
                  — Дженнифер Лопес, Джеки Чану, Николь Шерзингер, Кери Хилсон; видео с
                  портретом Энрике Иглесиаса артист опубликовал в своём официальном
                  аккаунте. В 2026 году творчество художницы отмечено в The Independent
                  и включено в глобальный список новаторов TikTok The Discover List 2026.
                </p>
                <p className="font-sans text-sm leading-[1.9] text-muted-foreground">
                  ...
                  в Париже, Баку, Берлине и Пекине.
                </p>
              </div>
            </FadeIn>
          </div>
            ...
            <FadeIn delay={0.1} className="lg:col-span-8">
              <div className="space-y-8">
                ...
                <p className="font-sans text-sm leading-[1.9] text-ivory/70">
                  Готовый тканый ковёр берётся в качестве основного холста. Портрет
                  наносится поверх ворса — в том числе аэрозольными красками, — при этом
                  часть аутентичного орнамента остаётся видимой и интегрируется в черты
                  лица, одежду или силуэт персонажа: рисунок ковра и живопись образуют
                  единое художественное высказывание.
                </p>
                <p className="font-sans text-sm leading-[1.9] text-ivory/70">
                  Идеология направления — синтез исторической памяти, тюркского
                  традиционного орнамента, уличного искусства (street-art), портретной
                  живописи и digital-культуры. Символический манифест KilemArt — образ
                  Көкбөрі, мифической волчицы-прародительницы тюрков: после этой работы
                  ковёр утвердился как главный художественный носитель художницы.
                </p>
            ...
            {timeline.map((period) => (
              ...
              >
                <FadeIn className="lg:col-span-3">
                  <p className="font-sans text-sm text-muted-foreground">{period.years}</p>
        ...
        <div className="mx-auto max-w-[1400px]">
          <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
            ...
            <FadeIn delay={0.1} className="lg:col-span-8">
              <div className="space-y-8">
                <p className="font-serif text-2xl font-light leading-relaxed text-ivory md:text-3xl">
                  Переосмысление традиций и репрезентация культурного кода Казахстана
                  через актуальный язык contemporary art.
                </p>
                <p className="font-sans text-sm leading-[1.9] text-ivory/70">
                  Ковёр трактуется как символ дома, рода, предков и культурной
                  преемственности, а цифровой контент — как полноценное самостоятельное
                  медиаискусство, вовлекающее молодёжь.
                </p>
                <p className="font-sans text-sm leading-[1.9] text-ivory/70">
                  Основанная Асель инфраструктура — Assolyaa Arts Center в Алматы:
                  собственное арт-пространство и образовательная студия. Ведёт
                  образовательные программы для молодых художников, продвигая модель
                  арт-предпринимателя нового типа, гармонично сочетающего академическую
                  школу, собственный почерк, медийность и сотрудничество с брендами.
                </p>
              </div>
            </FadeIn>
          </div>
